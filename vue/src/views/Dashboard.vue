<template>
    <PageComponent title="Dashboard">
        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 text-gray-700">
            ...
            <div class="bg-white shadow-md p-3 text-center flex flex-col animate-fade-in-down order-2 lg:order-4" style="animation-delay: 0.2s">
                <h3 class="text-2xl font-semibold">Total Answers</h3>
                <div class="text-8xl font-semibold flex-1 flex items-center justify-center">
                    {{ data.totalAnswers }}
                </div>
            </div>
            <div class="row-span-2 order-3 lg:order-1 bg-white shadow-md p-4 animate-fade-in-down" style="animation-delay: 0.3s">
